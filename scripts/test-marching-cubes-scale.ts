...
function testMarchingCubesScale(inputRadius: number): {
	inputRadius: number;
	outputRadius: number;
	scaleFactor: number;
} {
...
const testRadii = [0.1, 0.14, 0.16, 0.22, 0.3];
...
function testTubeScale(inputRadius: number): {
	inputRadius: number;
	outputRadius: number;
	scaleFactor: number;
} {
...
function testActualVesselGeometry(inputRadius: number): {
	inputRadius: number;
	outputRadius: number;
	scaleFactor: number;
} {
